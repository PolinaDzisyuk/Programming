...
![alt text](<screenshots/Снимок экрана 2025-11-21 100332.png>)
![alt text](<screenshots/Снимок экрана 2025-11-21 100519.png>)
2. git log говорит, что коммитов ещё не было
![alt text](<Снимок экрана 2025-11-21 100545.png>)
...
![alt text](<Снимок экрана 2025-11-21 103306.png>)
8. git status показывает, что нет новых или изменённых файлов
![alt text](<Снимок экрана 2025-11-21 103621.png>)
9. 10. 11. 12. Добавила комментарий #hello git 
![alt text](<Снимок экрана 2025-11-21 103705.png>)
...
15. 
![alt text](<Снимок экрана 2025-11-21 104548.png>)
16. Первый пуш
![alt text](<Снимок экрана 2025-11-26 151756-1.png>)
![alt text](<Снимок экрана 2025-11-26 152721-1.png>)
...
![alt text](<Снимок экрана 2025-11-28 095528.png>)
3. git diff показывает, что было добавлено
![alt text](<Снимок экрана 2025-11-26 153830.png>)
4. git diff --staged пустой
5. Добавляю sort.c в staged
![alt text](<Снимок экрана 2025-11-26 153843-2.png>)
6. Теперь git diff пустой
7.  git diff --staged показывает изменения в файле
![alt text](<Снимок экрана 2025-11-26 154923.png>)
8. Удаляю из массива 0
![alt text](<Снимок экрана 2025-11-26 154717.png>)
9. 10. 
![alt text](<Снимок экрана 2025-11-28 095915.png>)
...
![alt text](<Снимок экрана 2025-11-26 155033.png>)
...
![alt text](<Снимок экрана 2025-11-27 105935-1.png>)
![alt text](<Снимок экрана 2025-11-28 101455.png>)
17. В файле sort.c был добавлен в main() printf(“hello git\n”)
18. Его содержимое:
![alt text](<Снимок экрана 2025-11-28 101605.png>)
19. 20. git status гворит, что файл sort.c был изменён и не добавлен в staged
![alt text](<Снимок экрана 2025-11-28 101703.png>)
21. Можно увидеть, что изменения исчезли
22. git status больше не видит изменений в файле 
![alt text](<Снимок экрана 2025-11-28 101723.png>)
23. 
![alt text](<Снимок экрана 2025-11-28 101750.png>)

# Ветки и ff-merge

1. Был создан greeting.txt, проиндексирован с помощью git add и закоммичен с сообщением “Add file greeting.txt”
![alt text](<Снимок экрана 2025-11-28 102136.png>)
2. Добавлено hello
![alt text](<Снимок экрана 2025-11-28 102221.png>)
...
![alt text](<Снимок экрана 2025-11-28 102516.png>)
9. 
![alt text](<Снимок экрана 2025-11-28 102636.png>)
10. 11. Переключилась на mybranch и в этой ветке с помощью команды cat вывела терминале содержимое файла
![alt text](<Снимок экрана 2025-11-28 102856.png>)
12. Ветки содержат один и тот же файл
13. С помощью git merge объединяю ветки
![alt text](<Снимок экрана 2025-11-28 103202.png>)
14. Удаляю ветку feature/uppercase с помощью опции -d команды git branch. Переключаюсь на ветку master
![alt text](<Снимок экрана 2025-11-28 103555.png>)
15. 16. Сделала коммит, чтобы смержить ветки
![alt text](<Снимок экрана 2025-11-28 103847.png>)
17. 
![alt text](<Снимок экрана 2025-11-28 103901.png>)
...
![alt text](<Снимок экрана 2025-11-28 104244.png>)
![alt text](<Снимок экрана 2025-11-28 104311.png>)
4. 5. Переключилась на master и выполнила команду 
echo "This is an indispensable truth!" > file.txt 
![alt text](<Снимок экрана 2025-11-28 104549.png>)
6. 
![alt text](<Снимок экрана 2025-11-28 104751.png>)
...
![alt text](<Снимок экрана 2025-11-28 104900.png>)
9. Исправляю конфликт в VSCode
![alt text](<Снимок экрана 2025-11-28 104952.png>)
![alt text](<Снимок экрана 2025-11-28 105148.png>)
![alt text](<Снимок экрана 2025-11-28 105205.png>)
![alt text](<Снимок экрана 2025-11-28 105943.png>)
![alt text](<Снимок экрана 2025-11-28 110105.png>)
10. 
![alt text](<Снимок экрана 2025-11-28 110141.png>)
11. Запушила на удалённый репо
![alt text](<Снимок экрана 2025-11-28 110201.png>)
...
![alt text](<Снимок экрана 2025-11-28 111223.png>)
6. 7. 8. Переключаемся на master и меняю все содержимое mergesort.py на lefty.py
![alt text](<Снимок экрана 2025-11-28 111235.png>)
9. Вывод git branch
![alt text](<Снимок экрана 2025-11-28 111306.png>)
10. Пытаюсь смержить ветки и получаю мерже конфликт. Решаю его принятием изменений
![alt text](<Снимок экрана 2025-11-28 111401.png>)
![alt text](<Снимок экрана 2025-11-28 111559.png>)
11. Коммичу с сообщением "мерж конфликт решён"
![alt text](<Снимок экрана 2025-11-28 111809.png>)
12. 
![alt text](<Снимок экрана 2025-11-29 153550.png>)